...
async def set_webhook(url, headers, body):
...
async def set_telegram_webhook():
    ...
    headers = {}
    body = {
        'url': urljoin(api_url, 'webhook/telegram'),
...
async def set_viber_webhook():
    ...
    body = {
        "url": urljoin(api_url, 'webhook/viber'),
        "event_types": [
...
async def set_facebook_webhook():
    ...
    body = {
        ...
        "callback_url": urljoin(api_url, 'webhook/facebook'),
